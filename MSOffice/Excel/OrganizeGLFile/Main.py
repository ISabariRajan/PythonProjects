...
for sh1 in sheet1_array:
    print(f"Populating Output for L1: {sh1[0]}")
    for sh2 in sheet2_array:
        work_sheet.cell(row=start_row, column=2).value = sh2[1]
        work_sheet.cell(row=start_row, column=3).value = sh1[0]
        work_sheet.cell(row=start_row, column=4).value = sh1[1]
        work_sheet.cell(row=start_row, column=5).value = sh1[2]
        work_sheet.cell(row=start_row, column=6).value = sh1[3]
        work_sheet.cell(row=start_row, column=7).value = sh2[0]
        start_row += 1
        # break
